...
To use these stylesheets, rename the files and la_almarcha with the name of your theme.
...
la_almarcha-alpha-default-narrow.css  
...
la_almarcha-alpha-default-normal.css
...
la_almarcha-alpha-default-wide.css
